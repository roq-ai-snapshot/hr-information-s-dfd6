  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System - Your complete solution for managing employee data, vacations, and payroll efficiently. Empower your business today!"
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Your complete solution for managing employee data, vacations, and payroll efficiently. Empower your business today!`}
            </Text>
            <Box
